...
def get_landing_takeoff_data(
    ...
    result["adjusted_obstacle_clearance_ft"] = result["adjusted_obstacle_clearance_ft"] + \
        surface_correction * result["adjusted_groundroll_ft"] / 100
    result["adjusted_groundroll_ft"] = result["adjusted_groundroll_ft"] + \
        surface_correction * result["adjusted_groundroll_ft"] / 100
